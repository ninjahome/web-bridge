...
//
// Solidity: function allTeamInfo(uint256 roundNo) view returns(uint256[] memCounts, uint256[] voteCounts)
...
// VoteNoOfTeamate is a free data retrieval call binding the contract method 0x48922fbd.
//
// Solidity: function voteNoOfTeamate(uint256 roundNo, bytes32 tweet, address memAddr) view returns(uint256, uint256, uint256)
func (_TweetLotteryGame *TweetLotteryGameCaller) VoteNoOfTeamate(opts *bind.CallOpts, roundNo *big.Int, tweet [32]byte, memAddr common.Address) (*big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _TweetLotteryGame.contract.Call(opts, &out, "voteNoOfTeamate", roundNo, tweet, memAddr)
...
//
// Solidity: function voteNoOfTeamate(uint256 roundNo, bytes32 tweet, address memAddr) view returns(uint256, uint256, uint256)
func (_TweetLotteryGame *TweetLotteryGameSession) VoteNoOfTeamate(roundNo *big.Int, tweet [32]byte, memAddr common.Address) (*big.Int, *big.Int, *big.Int, error) {
	return _TweetLotteryGame.Contract.VoteNoOfTeamate(&_TweetLotteryGame.CallOpts, roundNo, tweet, memAddr)
}

// VoteNoOfTeamate is a free data retrieval call binding the contract method 0x48922fbd.
//
// Solidity: function voteNoOfTeamate(uint256 roundNo, bytes32 tweet, address memAddr) view returns(uint256, uint256, uint256)
func (_TweetLotteryGame *TweetLotteryGameCallerSession) VoteNoOfTeamate(roundNo *big.Int, tweet [32]byte, memAddr common.Address) (*big.Int, *big.Int, *big.Int, error) {
	return _TweetLotteryGame.Contract.VoteNoOfTeamate(&_TweetLotteryGame.CallOpts, roundNo, tweet, memAddr)
}
