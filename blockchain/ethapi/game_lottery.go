...
//
// Solidity: function gameInfoRecord(uint256 ) view returns(bytes32 randomHash, uint256 discoverTime, address winner, uint256 winTicketID, uint256 bonus, uint256 bonusForWinner, uint256 randomVal)
func (_TweetLotteryGame *TweetLotteryGameCaller) GameInfoRecord(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.BonusForWinner = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
...
//
// Solidity: function historyRoundInfo(uint256 from, uint256 to) view returns((bytes32,uint256,address,uint256,uint256,uint256,uint256)[] infos)
...
func (_TweetLotteryGame *TweetLotteryGameCaller) SystemSettings(opts *bind.CallOpts) (struct {
	RoundNo        *big.Int
	TBonus         *big.Int
	CurTicketNo    *big.Int
	TickPrice      *big.Int
	...
	outstruct.RoundNo = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.TBonus = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
	outstruct.CurTicketNo = *abi.ConvertType(out[2], new(*big.Int)).(**big.Int)
	outstruct.TickPrice = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.BonusPoint = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.IsOpenForOuter = *abi.ConvertType(out[5], new(bool)).(*bool)
...
//
// Solidity: function systemSettings() view returns(uint256 roundNo, uint256 tBonus, uint256 curTicketNo, uint256 tickPrice, uint256 bonusPoint, bool isOpenForOuter)
func (_TweetLotteryGame *TweetLotteryGameSession) SystemSettings() (struct {
	RoundNo        *big.Int
	TBonus         *big.Int
	CurTicketNo    *big.Int
	TickPrice      *big.Int
...
//
// Solidity: function systemSettings() view returns(uint256 roundNo, uint256 tBonus, uint256 curTicketNo, uint256 tickPrice, uint256 bonusPoint, bool isOpenForOuter)
func (_TweetLotteryGame *TweetLotteryGameCallerSession) SystemSettings() (struct {
	RoundNo        *big.Int
	TBonus         *big.Int
	CurTicketNo    *big.Int
	TickPrice      *big.Int
...
func (_TweetLotteryGame *TweetLotteryGameTransactor) TransferBonusOfPoints(opts *bind.TransactOpts, tokenContract common.Address) (*types.Transaction, error) {
	return _TweetLotteryGame.contract.Transact(opts, "transferBonusOfPoints", tokenContract)
}
...
func (_TweetLotteryGame *TweetLotteryGameSession) TransferBonusOfPoints(tokenContract common.Address) (*types.Transaction, error) {
	return _TweetLotteryGame.Contract.TransferBonusOfPoints(&_TweetLotteryGame.TransactOpts, tokenContract)
}
