...
// AllTeamInfo is a free data retrieval call binding the contract method 0xfc4fca26.
//
// Solidity: function allTeamInfo(uint256 roundNo, bytes32[] tweets) view returns(uint256[] memCounts, uint256[] voteCounts)
func (_TweetLotteryGame *TweetLotteryGameCaller) AllTeamInfo(opts *bind.CallOpts, roundNo *big.Int, tweets [][32]byte) (struct {
	MemCounts  []*big.Int
	VoteCounts []*big.Int
}, error) {
	var out []interface{}
	err := _TweetLotteryGame.contract.Call(opts, &out, "allTeamInfo", roundNo, tweets)
	...
	outstruct.MemCounts = *abi.ConvertType(out[0], new([]*big.Int)).(*[]*big.Int)
...
//
// Solidity: function allTeamInfo(uint256 roundNo, bytes32[] tweets) view returns(uint256[] memCounts, uint256[] voteCounts)
func (_TweetLotteryGame *TweetLotteryGameSession) AllTeamInfo(roundNo *big.Int, tweets [][32]byte) (struct {
	MemCounts  []*big.Int
	VoteCounts []*big.Int
}, error) {
	return _TweetLotteryGame.Contract.AllTeamInfo(&_TweetLotteryGame.CallOpts, roundNo, tweets)
}

// AllTeamInfo is a free data retrieval call binding the contract method 0xfc4fca26.
//
// Solidity: function allTeamInfo(uint256 roundNo, bytes32[] tweets) view returns(uint256[] memCounts, uint256[] voteCounts)
func (_TweetLotteryGame *TweetLotteryGameCallerSession) AllTeamInfo(roundNo *big.Int, tweets [][32]byte) (struct {
	MemCounts  []*big.Int
	VoteCounts []*big.Int
}, error) {
	return _TweetLotteryGame.Contract.AllTeamInfo(&_TweetLotteryGame.CallOpts, roundNo, tweets)
...
// TeamInfo is a free data retrieval call binding the contract method 0xb995afb9.
//
// Solidity: function teamInfo(uint256 roundNo, bytes32 tweet) view returns(uint256, uint256)
func (_TweetLotteryGame *TweetLotteryGameCaller) TeamInfo(opts *bind.CallOpts, roundNo *big.Int, tweet [32]byte) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _TweetLotteryGame.contract.Call(opts, &out, "teamInfo", roundNo, tweet)
...
//
// Solidity: function teamInfo(uint256 roundNo, bytes32 tweet) view returns(uint256, uint256)
func (_TweetLotteryGame *TweetLotteryGameSession) TeamInfo(roundNo *big.Int, tweet [32]byte) (*big.Int, *big.Int, error) {
	return _TweetLotteryGame.Contract.TeamInfo(&_TweetLotteryGame.CallOpts, roundNo, tweet)
}

// TeamInfo is a free data retrieval call binding the contract method 0xb995afb9.
//
// Solidity: function teamInfo(uint256 roundNo, bytes32 tweet) view returns(uint256, uint256)
func (_TweetLotteryGame *TweetLotteryGameCallerSession) TeamInfo(roundNo *big.Int, tweet [32]byte) (*big.Int, *big.Int, error) {
	return _TweetLotteryGame.Contract.TeamInfo(&_TweetLotteryGame.CallOpts, roundNo, tweet)
}
...
// TeamListOfRound is a free data retrieval call binding the contract method 0x39b01766.
//
// Solidity: function teamListOfRound(uint256 round) view returns(bytes32[] teams)
func (_TweetLotteryGame *TweetLotteryGameCaller) TeamListOfRound(opts *bind.CallOpts, round *big.Int) ([][32]byte, error) {
	var out []interface{}
	err := _TweetLotteryGame.contract.Call(opts, &out, "teamListOfRound", round)
...
//
// Solidity: function teamListOfRound(uint256 round) view returns(bytes32[] teams)
func (_TweetLotteryGame *TweetLotteryGameSession) TeamListOfRound(round *big.Int) ([][32]byte, error) {
	return _TweetLotteryGame.Contract.TeamListOfRound(&_TweetLotteryGame.CallOpts, round)
}

// TeamListOfRound is a free data retrieval call binding the contract method 0x39b01766.
//
// Solidity: function teamListOfRound(uint256 round) view returns(bytes32[] teams)
func (_TweetLotteryGame *TweetLotteryGameCallerSession) TeamListOfRound(round *big.Int) ([][32]byte, error) {
	return _TweetLotteryGame.Contract.TeamListOfRound(&_TweetLotteryGame.CallOpts, round)
}
...
func (_TweetLotteryGame *TweetLotteryGameCaller) TeamMembersCountForGame(opts *bind.CallOpts, roundNo *big.Int, tweet [32]byte, memAddr common.Address) (*big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _TweetLotteryGame.contract.Call(opts, &out, "teamMembersCountForGame", roundNo, tweet, memAddr)
...
func (_TweetLotteryGame *TweetLotteryGameSession) TeamMembersCountForGame(roundNo *big.Int, tweet [32]byte, memAddr common.Address) (*big.Int, *big.Int, *big.Int, error) {
	return _TweetLotteryGame.Contract.TeamMembersCountForGame(&_TweetLotteryGame.CallOpts, roundNo, tweet, memAddr)
}
...
func (_TweetLotteryGame *TweetLotteryGameTransactor) ChangeOwner(opts *bind.TransactOpts, stop bool) (*types.Transaction, error) {
	return _TweetLotteryGame.contract.Transact(opts, "changeOwner", stop)
}
...
func (_TweetLotteryGame *TweetLotteryGameSession) ChangeOwner(stop bool) (*types.Transaction, error) {
	return _TweetLotteryGame.Contract.ChangeOwner(&_TweetLotteryGame.TransactOpts, stop)
}
...
func (_TweetLotteryGame *TweetLotteryGameTransactor) ChangeOwner0(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _TweetLotteryGame.contract.Transact(opts, "changeOwner0", newOwner)
}
...
func (_TweetLotteryGame *TweetLotteryGameSession) ChangeOwner0(newOwner common.Address) (*types.Transaction, error) {
	return _TweetLotteryGame.Contract.ChangeOwner0(&_TweetLotteryGame.TransactOpts, newOwner)
}
